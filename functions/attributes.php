...
function fs_attr_filter($group_id, $args = array())
{
    ...
    if ($terms) {
        ...
        foreach ($terms as $key => $term) {
            ...
            do_action('fs_attr_filter_item_before', ['term' => $term, 'value' => $value, 'remove_attr' => $remove_attr]);
            ...
            do_action('fs_attr_filter_item_after', ['term' => $term, 'value' => $value, 'remove_attr' => $remove_attr]);
