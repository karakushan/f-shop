<h3><?php _e( 'Purchase options', 'f-shop' ) ?></h3>
<p><?php _e( 'This tab is relevant if you have several varieties of a single product.', 'f-shop' ) ?></p>
<?php
global $fs_config;
...
?>
<button type="button" class="button" id="fs-add-variant"><?php _e( 'add variant', 'f-shop' ) ?> <img
            src="<?php echo FS_PLUGIN_URL . 'assets/img/ajax-loader.gif' ?>" alt="preloader" class="fs-preloader">
</button>
<a href="javascript:void(0)" class="fs-collapse-all"><?php _e( 'Expand / hide all', 'f-shop' ) ?></a>
