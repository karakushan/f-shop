...
<div class="fs-field-row clearfix">
  <label for="fs_product_article"><?php _e( 'Article', 'f-shop' ) ?></label>
  <input type="text" name="<?php echo $this->config->meta['sku'] ?>" id="fs_product_article"
         value="<?php echo fs_product_code(); ?>" id="price">
</div>
<div class="fs-field-row clearfix">
  <label for="fs_remaining_amount"><?php _e( 'Запас товара на складе', 'f-shop' ) ?> <span>единиц</span></label>
...
<div class="fs-field-row clearfix">
  ...
  <div class="checkbox-wrapper">
    <input type="checkbox" id="fs_exclude_archive"
           ...
           value="1">
    <label for="fs_exclude_archive"><?php _e( 'Исключить из архива товаров', 'f-shop' ) ?> </label>
  </div>
</div>
<div class="fs-field-row  clearfix">
  ...
  <div class="checkbox-wrapper"><input type="checkbox" id="fs_on_bestseller"
                                        ...
                                        value="1"><label
      for="fs_on_bestseller"><?php _e( 'Включить метку "Хит продаж"', 'f-shop' ) ?> </label></div>
</div>
<div class="fs-field-row clearfix">
  <div class="checkbox-wrapper">
    ...
    <input type="checkbox" id="fs_on_promotion"
           ...
           value="1">
    <label
      for="fs_on_promotion"><?php _e( 'Включить метку "Акция"', 'f-shop' ) ?> </label>
  </div>
  ...
  <div class="checkbox-wrapper">
    ...
    <input type="checkbox" id="<?php echo esc_attr( $this->config->meta['label_novelty'] ) ?>"
           ...
           value="1">
    <label
      for="<?php echo esc_attr( $this->config->meta['label_novelty'] ) ?>"><?php _e( 'Включить метку "Новинка"', 'f-shop' ) ?> </label>
  </div>
</div>