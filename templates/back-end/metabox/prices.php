...
<?php if ( $prices = fs_get_all_prices() ): ?>
    ...
    <div class="fs-field-row clearfix">
      <label for="fs-<?php echo $key ?>"><?php echo $price['name'] ?> <span><?php echo fs_currency() ?></span></label>
      <input type="text" name="<?php echo $price['meta_key'] ?>" id="fs-<?php echo $key ?>" size="10"
...
<?php endif ?>
<div class="fs-field-row clearfix">
  <label for="fs-currency">Валюта товара</label>
	<?php
