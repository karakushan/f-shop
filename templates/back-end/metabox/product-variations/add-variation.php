...
<div class="fs-rule fs-field-row" data-index="<?php echo esc_attr($index) ?>">
    ...
    <div class="fs-flex form-row">
        <div class="col">
            ...
            <input type="text" name="fs_variant[<?php echo esc_attr($index) ?>][name]"
                   value="<?php if (!empty($variant['name'])) echo esc_attr($variant['name']) ?>">
        </div>
        <div class="col">
    ...
    <div class="fs-flex">
        ...
        <a class="hide-if-no-js taxonomy-add-new" data-fs-element="clone-att">+ <?php esc_html_e('add property', 'f-shop') ?></a></div>
