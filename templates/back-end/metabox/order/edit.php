...
<div class="fs-order-edit" x-data="{
    ...
    <section class="fs-order-edit__section">
        <div class="fs-order-edit__toolbar">
            ...
            <button type="button" class="button" x-on:click.prevent="showSelectProduct=true"><?php _e('Add product','f-shop'); ?></button>
        </div>
            ...
            <template x-for="(item, index) in items">
                <div class="fs-order-edit__item">
                    ...
                    <div class="fs-order-edit__item-action">
                        <button x-on:click.prevent="if(confirm('<?php _e('Do you confirm deletion?', 'f-shop'); ?>')) items.splice(index, 1)" class="fs-order-edit__btn-danger"
    ...
    <section class="fs-order-edit__section">
        ...
        <div class="fs-order-history">
            <?php foreach ($order->get_order_history() as $event): ?>
                <div x-data="{isOpen:false}" class="fs-order-history__item" :class="{'fs-order-history__item-open': isOpen}">
