...
<div class="fs-comments">
    ...
    <div class="fs-comments__area">
        ...
        <div class="fs-comments__form">
            ...
            comment_form( [
				'title_reply'         => __( 'Оставить отзыв', 'ecoveles' ),
		...
		<input id="email" name="email" placeholder="' . __( 'Email' ) . '"  value="' . esc_attr( $commenter['comment_author_email'] ) . '" aria-describedby="email-notes" />
				...
				'comment_field'        => '<p class="comment-form-comment"><textarea id="comment" placeholder="' . _x( 'Comment', 'noun' ) . '" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>'. $product->product_rating(0,['echo'=>false,'before'=>'<div class="rating-before">'.__('Оценка товара:','ecoveles').'</div>']),
				'label_submit'         => __( 'ДОБАВИТЬ ОТЗЫВ', 'ecoveles' ),
