...
<div class="form-group">
    ...
    <input type="text" name="fs-login" class="form-control" id="fs-login" value="<?php echo $user->user_login ?>" required title="<?php _e('required field','fast-shop') ?>">
</div>
<div class="form-group row">
    <div class="col-md-6">
        <label for="fs-password"><?php _e('Password','fast-shop') ?></label>
        <input type="password" name="fs-password" class="form-control" id="fs-password" required title="<?php _e('required field','fast-shop') ?>">
    </div>
