...
<h3 class="form-block-t">Обязательные поля</h3> 
    ...
    <div class="form-group">
        <label for="fs-password"><?php _e('New password','f-shop') ?></label>
   ...
   <h3 class="form-block-t">Дополнительная информация</h3> 
    ...
    <button type="submit" class="button-t1"><?php _e('Save','f-shop') ?> <img src="/wp-content/plugins/f-shop/assets/img/heart.svg" alt="preloader" class="fs-preloader"></button>
</form>