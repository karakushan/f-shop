<form action="" name="fs-login" class="fs-login-form"  method="post">
    ...
    <div class="form-header">Для входа в личный кабинет необходимо пройти авторизацию. <a href="<?php echo add_query_arg(array('fs-page'=>'register'),get_permalink(2413)) ?>">Регистрация</a> </div>
