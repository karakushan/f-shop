...
<head>
  ...
  <title><?php _e( 'Order on the site', 'fast-shop' ) ?> &laquo;<?php bloginfo( 'name' ) ?>&raquo;</title>
                    ...
                    <td class="pull-left mobile-header-padding-left"
						...
						<?php else: ?>
                          <a href="<?php echo esc_url( get_bloginfo( 'url' ) ) ?>">
                            <span
                              style="font-size: 20px; font-weight: bold;color: #4d4d4d;"><?php echo fs_option( 'name_sender', get_bloginfo( 'name' ) ) ?></span>
                          </a>
						<?php endif; ?>
          ...
          <tr>
            <td class="item-table">
              <table cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <tr>
                              ...
                              <td class="product">
                                <span style="color: #4d4d4d; font-weight:bold;"><a
                                    href="<?php echo $p['link'] ?>" target="_blank"><?php echo $p['name'] ?></a></span>
                                <br/>
								  <?php if ( ! empty( $p['attr'] ) ): ?>
                ...
                <tr>
                  <td class="item-col price" colspan="4" style="text-align: right; border-top: 1px solid #cccccc;">
                  <span class="total-space"
                        style="font-weight: bold; color: #4d4d4d"><?php _e( 'Total', 'fast-shop' ) ?></span> <span
                      class="total-space"
