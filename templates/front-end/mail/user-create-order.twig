        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td class="header-lg">
                            {{ __('Thank you for your order!','f-shop') }}
                        </td>
                    </tr>
                    <tr>
                        <td class="free-text">
                            {{ __('Your order #%d has been successfully created. We will contact you shortly. If this did not happen within 1-2 days, then contact us for these contact details:','f-shop')|format(order_id) }}
                            <br/>
                            {% if contact_phone %}<a href="tel:{{ contact_phone|clean_number }}">{{ contact_phone }}</a>
                                <br/>{% endif %}
                            {% if contact_email %} <a
                                href="mailto:{{ contact_email }}">{{ contact_email }}</a>{% endif %}
                        </td>
                    </tr>
                    <tr>
                        <td class="button">
                            <div><!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                             xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ dashboard_url }}"
                                    ...
                                    <center style="color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;">
                                        {{ __('Personal Area','f-shop') }}
                                    </center>
                                </v:roundrect>
                                <![endif]--><a href="{{ dashboard_url }}"
                                               style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">{{ __('Personal Area','f-shop') }}</a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="mini-block">
                                                                ...
                                                                {% if delivery_method %} {{ __("Delivery method",'f-shop') }}:  {{ delivery_method }}{% endif %}
                                                                {% if delivery_number %}, {{ delivery_number }}{% endif %}
                                                                <br/>
                                                                {% if client_city %} {{ __('City','f-shop') }}: {{ client_city }}
                                                                    <br/>{% endif %}
                                                                {% if client_address %} {{ __("Address",'f-shop') }}: {{ client_address }}
                                                                    <br/>{% endif %}
                                                                {% if client_first_name %} {{ __("First Name",'f-shop') }} {{ __("Last name",'f-shop') }}: {{ client_first_name }} {{ client_last_name }}
                                                                    <br/>{% endif %}
                                                                {% if client_phone %} {{ __("Phone number",'f-shop') }}: {{ client_phone }} {% endif %}
                                                                <br/>
                                        ...
                                        <td class="item-col item">
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td class="product">
                                                        <a href="{{ item.link }}" target="_blank"
                                                           style="color: #4d4d4d; font-weight:bold;">{{ item.name|html_entity_decode }}</a>
                                                        <br/>
