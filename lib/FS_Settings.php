            ...
            'fields' => [
                ...
                [
                    ...
                    'values' => [
                        ...
                        'stock_priority' => __('By availability priority', 'f-shop'),
                        'action_price' => __('First promotional', 'f-shop'),
                        'rating_desc' => __('By rating', 'f-shop'),
                    ],
        ...
        return [
            ...
            'fields' => [
                ...
                [
                    ...
                    'label' => __('Telegram notifications', 'f-shop'),
                    'value' => fs_option('fs_notify_telegram', 0),
                    'after' => sprintf(__('To receive Telegram notifications, add the bot <a href="%s" target="_blank">@FShopOfficialBot</a> and send it any message, for example "Hi".', 'f-shop'), 'https://t.me/FShopOfficialBot'),
                ],
                [
                    'type' => 'text',
                ...
                [
                    ...
                    'label' => __('Telegram user IDs', 'f-shop'),
                    'value' => fs_option('fs_telegram_user_id'),
                    'textarea_rows' => 5,
                    'after' => sprintf(__('Enter one Telegram user ID per line. You can find your user ID via <a href="%s" target="_blank">@getmyid_bot</a>.', 'f-shop'), 'https://t.me/getmyid_bot'),
                ],
                [
                    'type' => 'html',
                    'name' => 'fs_telegram_test_action',
                    'label' => __('Test Telegram delivery', 'f-shop'),
                    'value' => '<button type="button" class="button button-secondary" id="fs-telegram-test-button">' . esc_html__('Send test message', 'f-shop') . '</button><div id="fs-telegram-test-result" class="fs-field-after" style="display:none;"></div>',
                    'after' => __('Sends a test notification to all configured Telegram user IDs.', 'f-shop'),
                ],
            ],
        ];
    }
