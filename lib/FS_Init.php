...
class FS_Init {
	...
	function fast_shop_scripts() {
		...
		wp_enqueue_style( FS_PLUGIN_PREFIX . 'twentynineteen', FS_PLUGIN_URL . 'templates/front-end/assets/css/twentynineteen.css' );
		...
		$l10n      = array(
			...
			'lang'              => array(
				...
				'addToCart'          => __( 'Item &laquo;%product%&raquo; successfully added to cart. <a href="%cart_url%">Go to shopping cart</a>', 'f-shop' ),
