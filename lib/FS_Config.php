...
class FS_Config
{
    ...
    public function __construct()
    {
        ...
        $this->options = get_option('fs_option', []);
        ...
        self::$user_meta = [
            'display_name' => ['label' => __('Display Name', 'f-shop'), 'name' => 'display_name'],
            'user_email' => ['label' => __('E-mail', 'f-shop'), 'name' => 'user_email'],
            'phone' => ['label' => __('Phone number', 'f-shop'), 'name' => 'phone'],
            'birth_day' => ['label' => __('Date of Birth', 'f-shop'), 'name' => 'birth_day'],
            'gender' => ['label' => __('Gender', 'f-shop'), 'name' => 'gender'],
            'state' => ['label' => __('State / Province', 'f-shop'), 'name' => 'state'],
            'country' => ['label' => __('Country', 'f-shop'), 'name' => 'country'],
            'city' => ['label' => __('City', 'f-shop'), 'name' => 'city'],
     ...
     * @param bool $html
     */
    public function email_headers($html = true)
    {
        $headers = [];
        if ($html) {
     ...
     * @return mixed|void
     */
    public static function default_language_name()
    {
