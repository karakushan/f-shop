...
class FS_Images_Class
{
     ...
     * @return bool|string
     */
    public function product_gallery_list($product_id = 0, $args = [])
    {
     ...
     * @return void
     */
    public static function product_gallery_display($product_id = 0, $args = [])
    {
        $product_id = fs_get_product_id($product_id);
...
<?php
     ...
     */
    public function gallery_images_url($product_id = 0, $args = [])
    {
        $product_id = fs_get_product_id($product_id);
     ...
     * @return bool
     */
    public function update_gallery($product_id = 0, $attach_id = 0)
    {
        $product_id = fs_get_product_id($product_id);
