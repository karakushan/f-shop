        ...
        $types = array(
            ...
            FS_Config::get_data('post_type_orders') => array(
                'labels' => array(
                    ...
                    'add_new_item' => __('Add Order', 'f-shop'),
                    'edit_item' => __('Edit order', 'f-shop'),
                    'new_item' => __('New order', 'f-shop'),
                    'view_item' => __('View order', 'f-shop'),
                    'search_items' => __('Search orders', 'f-shop'),
                    'not_found' => __('Orders not found', 'f-shop'),
                    'not_found_in_trash' => __('No orders found in trash', 'f-shop'),
                    'parent_item_colon' => '',
